                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {tool.comparisonData.bestFor.map((item, i) => (
                                            <span key={i} className="rounded-md border border-indigo-200 dark:border-indigo-500/20 bg-indigo-50 dark:bg-indigo-500/10 px-2 py-1 text-xs text-indigo-600 dark:text-indigo-400">{item}</span>
                                        ))}
                                    </div>
                                </div>
                                <div>
                                    <div className="mb-2 text-xs font-medium uppercase tracking-wider text-neutral-500">Pricing</div>
                                    <span className="text-sm text-neutral-900 dark:text-neutral-200">{tool.comparisonData.priceModel}</span>
                                </div>
                            </div>
                            <div className="space-y-6">
                                <div>
