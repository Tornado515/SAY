        ...
        <div className="container mx-auto px-4 pb-24 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-32">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-white">{t('vibeCodingPage.whatIs.title', { defaultValue: 'What is Vibe Coding?' })}</h2>
            ...
            <div className="relative group">
              ...
              <div className="relative p-8 bg-neutral-900 border border-white/10 rounded-xl">
                <pre className="font-mono text-sm text-indigo-300 overflow-x-auto" dir="ltr">
                  <code>{`// Old Way
...
// handling discounts and tax automatically"`}</code>
          ...
          <div className="mb-32">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-white mb-4">{t('vibeCodingPage.artOfPrompting.title', { defaultValue: 'The Art of Prompting' })}</h2>
          ...
          {/* Advanced Techniques */}
          <div className="mb-32">
            <h2 className="text-3xl font-bold text-white mb-12 text-center">{t('vibeCodingPage.advancedTechniques.title', { defaultValue: 'Advanced Techniques' })}</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 rounded-2xl bg-neutral-900/50 border border-white/5 hover:border-indigo-500/30 transition-colors">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white">{t('vibeCodingPage.advancedTechniques.roleBased.title', { defaultValue: 'Role-Based Prompting' })}</h3>
                </div>
                ...
                <div className="bg-black/30 rounded-lg p-4 font-mono text-sm text-indigo-300" dir="ltr">
              ...
              <div className="p-8 rounded-2xl bg-neutral-900/50 border border-white/5 hover:border-purple-500/30 transition-colors">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white">{t('vibeCodingPage.advancedTechniques.fewShot.title', { defaultValue: 'Few-Shot Prompting' })}</h3>
                </div>
                <p className="text-neutral-400 mb-6">
                ...
                <div className="bg-black/30 rounded-lg p-4 font-mono text-sm text-purple-300" dir="ltr">
              ...
              <div className="p-8 rounded-2xl bg-neutral-900/50 border border-white/5 hover:border-pink-500/30 transition-colors md:col-span-2">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-white">{t('vibeCodingPage.advancedTechniques.chainOfThought.title', { defaultValue: 'Chain-of-Thought' })}</h3>
                </div>
                <p className="text-neutral-400 mb-6">
                ...
                <div className="bg-black/30 rounded-lg p-4 font-mono text-sm text-pink-300" dir="ltr">
          ...
          <div className="mb-32 relative overflow-hidden rounded-3xl bg-neutral-900 border border-white/10 p-8 md:p-12">
            ...
            <div className="relative z-10">
              <h2 className="text-3xl font-bold text-white mb-8">{t('vibeCodingPage.contextIsKing.title', { defaultValue: 'Context is King' })}</h2>
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="bg-black/50 rounded-xl border border-white/10 p-6">
                  ...
                  <pre className="font-mono text-xs text-neutral-400 overflow-x-auto" dir="ltr">
...
Please add a function to update item quantity.`}</code>
          ...
          {/* The Iteration Loop */}
          <div className="mb-32">
            <h2 className="text-3xl font-bold text-white mb-12 text-center">{t('vibeCodingPage.iterationLoop.title', { defaultValue: 'The Iteration Loop' })}</h2>
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-white mb-4">{t('vibeCodingPage.iterationLoop.generate.title', { defaultValue: 'Generate' })}</h3>
                <p className="text-neutral-400">{t('vibeCodingPage.iterationLoop.generate.description', { defaultValue: 'Start with a clear, specific prompt to get the initial code.' })}</p>
              </div>
              <div className="p-6 relative">
                <div className="hidden md:block absolute top-1/2 -left-4 w-8 h-0.5 bg-neutral-800 rtl:right-auto rtl:left-4"></div>
                <div className="hidden md:block absolute top-1/2 -right-4 w-8 h-0.5 bg-neutral-800 rtl:left-auto rtl:right-4"></div>
                ...
                <h3 className="text-xl font-bold text-white mb-4">{t('vibeCodingPage.iterationLoop.review.title', { defaultValue: 'Review & Debug' })}</h3>
                <p className="text-neutral-400">{t('vibeCodingPage.iterationLoop.review.description', { defaultValue: 'Paste errors back to the AI. "I got this error: [error]. Fix it."' })}</p>
              </div>
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold text-white mb-4">{t('vibeCodingPage.iterationLoop.refine.title', { defaultValue: 'Refine' })}</h3>
                <p className="text-neutral-400">{t('vibeCodingPage.iterationLoop.refine.description', { defaultValue: 'Ask for optimizations. "Make it cleaner." "Add comments." "Optimize for speed."' })}</p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-12 text-center">{t('vibeCodingPage.promptEngineering101.title', { defaultValue: 'Prompt Engineering 101' })}</h2>
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl bg-red-500/5 border border-red-500/20">
                  ...
                  <p className="text-neutral-300 italic" dir="ltr">{t('vibeCodingPage.promptEngineering101.bad.text', { defaultValue: '"Make a login page."' })}</p>
                  <p className="mt-4 text-sm text-neutral-500">{t('vibeCodingPage.promptEngineering101.bad.desc', { defaultValue: 'Too vague. The AI will guess the stack, styling, and requirements.' })}</p>
                </div>
                <div className="p-6 rounded-xl bg-green-500/5 border border-green-500/20">
                  ...
                  <p className="text-neutral-300 italic" dir="ltr">{t('vibeCodingPage.promptEngineering101.good.text', { defaultValue: '"Create a login page using React and Tailwind. Include email/password fields, a \'Remember Me\' checkbox, and a \'Forgot Password\' link. Style it with a dark, glassmorphism aesthetic."' })}</p>
                  <p className="mt-4 text-sm text-neutral-500">{t('vibeCodingPage.promptEngineering101.good.desc', { defaultValue: 'Specific stack, features, and design requirements.' })}</p>
                </div>
              </div>
            </div>
          </div>
