        ...
        return (
            <Layout>
                <div className="flex h-[50vh] flex-col items-center justify-center text-center">
                    <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">Tool Not Found</h1>
                    ...
                    >
                        ...
                        <div className="mt-6 flex flex-wrap gap-4">
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center gap-2 rounded-full bg-neutral-900 dark:bg-white px-4 py-2.5 text-sm font-semibold text-white dark:text-neutral-900 shadow-sm hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-colors"
                            >
                            ...
                            <Link
                                ...
                                className="inline-flex items-center gap-2 rounded-full bg-white dark:bg-white/10 px-4 py-2.5 text-sm font-semibold text-neutral-900 dark:text-white shadow-sm ring-1 ring-inset ring-neutral-200 dark:ring-white/10 hover:bg-neutral-50 dark:hover:bg-white/20 transition-colors"
                            >
                                Compare Tool
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                            ...
                            <div className="space-y-8">
                                {tool.youtubeVideoId && (
                                    <div>
                                        ...
                                        <div className="overflow-hidden rounded-2xl bg-neutral-200 dark:bg-neutral-900 ring-1 ring-neutral-200 dark:ring-white/10 aspect-video">
                                            <iframe
                                                width="100%"
                                                height="100%"
                                ...
                                <div className="space-y-8 border-l-2 border-neutral-200 dark:border-white/10 pl-10 ml-3">
                                    {tool.steps?.map((step, index) => (
                                        <div key={index} className="relative group">
                                            {/* Step Number */}
                                            <span className="absolute -left-[39px] flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 dark:bg-neutral-900 ring-1 ring-neutral-200 dark:ring-white/20 text-sm font-mono text-neutral-600 dark:text-white/70 group-hover:bg-indigo-50 dark:group-hover:bg-indigo-500/10 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 group-hover:ring-indigo-500/30 transition-colors">
                                                {index + 1}
                                            </span>
                                                ...
                                                {step.code && (
                                                    <div className="mb-4 bg-neutral-100 dark:bg-black/50 rounded-lg border border-neutral-200 dark:border-white/5 overflow-hidden" dir="ltr">
                                                        ...
                                                        <div className="p-4 overflow-x-auto">
                                                            <pre className="text-sm font-mono text-indigo-600 dark:text-indigo-300 whitespace-pre-wrap break-words">
                                                                {step.code}
                                                            </pre>
                                                        </div>
                                                    </div>
                                                        ...
                                                        {step.links.map((link, i) => (
                                                            <a
                                                                ...
                                                                className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${link.primary
                                                                    ? 'bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-100 dark:hover:bg-indigo-500/20 ring-1 ring-indigo-200 dark:ring-indigo-500/30'
                                                                    : 'bg-neutral-100 dark:bg-white/5 text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-white hover:bg-neutral-200 dark:hover:bg-white/10'
                                                                    }`}
                                                            >
                                                                {link.text}
                                        ...
                                        {tool.relatedTools.map((related) => {
                                            ...
                                            return (
                                                <Link
                                                    ...
                                                    className="group flex flex-col p-4 rounded-xl bg-white dark:bg-white/5 ring-1 ring-neutral-200 dark:ring-white/10 hover:bg-neutral-50 dark:hover:bg-white/10 transition-all shadow-sm dark:shadow-none"
                                                >
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24 space-y-8">
                                ...
                                {/* Tags */}
                                <div>
                                    <h3 className="text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-3">Tags</h3>
