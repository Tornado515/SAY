                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                                ...
                                <AnimatePresence>
                                    {isToolFilterOpen && (
                                        <motion.div
                                            ...
                                            className="absolute right-0 mt-2 w-72 md:w-96 max-h-96 overflow-y-auto rounded-xl bg-neutral-900 border border-white/10 shadow-2xl p-4 ring-1 ring-black/5 z-50 rtl:right-auto rtl:left-0"
                                        >
                                            <div className="flex justify-between items-center mb-3">
                                                <span className="text-sm font-medium text-white">{t('techStacksPage.selectTools', { defaultValue: 'Select required tools' })}</span>
                                                <button
                    ...
                    {filteredStacks.length === 0 ? (
                        <div className="text-center py-20">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-2">{t('techStacksPage.noStacksFound', { defaultValue: 'No matching stacks found' })}</h3>
                            ...
                            {filteredStacks.map((stack) => (
                                ...
                                >
                                    ...
                                    <div className="p-8 flex-1 flex flex-col">
                                        <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-indigo-400 transition-colors pr-20 rtl:pr-0 rtl:pl-20">
