                                ...
                                <div className="grid sm:grid-cols-2 gap-4">
                                    {stackTools.map((tool) => (
                                        ...
                                        >
                                            ...
                                            <ChevronRight className="w-5 h-5 text-neutral-600 group-hover:text-indigo-400 flex-shrink-0 ml-4 rtl:rotate-180" />
                                        </Link>
                                    ))}
                                </div>
                            </section>
                                    ...
                                    {stack.walkthrough.steps.map((step, idx) => (
                                        <div key={idx} className="relative pl-8 sm:pl-12 rtl:pl-0 rtl:pr-8 sm:rtl:pr-12 group">
                                            ...
                                            {idx !== stack.walkthrough.steps.length - 1 && (
                                                <div className="absolute left-[15px] sm:left-[23px] rtl:left-auto rtl:right-[15px] sm:rtl:right-[23px] top-8 bottom-[-48px] w-0.5 bg-neutral-800 group-last:hidden" />
                                            )}

                                            {/* Number Bubble */}
                                            <div className="absolute left-0 sm:left-2 rtl:left-auto rtl:right-0 sm:rtl:right-2 top-0 flex h-8 w-8 items-center justify-center rounded-full bg-neutral-900 ring-1 ring-white/20 text-sm font-mono text-white/70 group-hover:bg-indigo-500/10 group-hover:text-indigo-400 group-hover:ring-indigo-500/30 transition-colors z-10">
                                                {idx + 1}
                                            </div>
                                            ...
                                            <div className="bg-neutral-900/50 rounded-2xl p-6 sm:p-8 border border-white/5 hover:border-white/10 transition-colors max-w-full">
                                                ...
                                                {step.code && (
                                                    <div className="mt-4 bg-black/50 rounded-lg border border-white/5 overflow-hidden" dir="ltr">
