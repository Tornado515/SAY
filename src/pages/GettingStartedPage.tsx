                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="mt-16 text-center bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20 rounded-2xl p-8">
                                <h3 className="text-2xl font-semibold text-indigo-600 dark:text-indigo-400 mb-3">
                                    {t('gettingStarted.cta.title', { defaultValue: 'Ready to dive slightly deeper?' })}
                                </h3>
                                <p className="text-neutral-600 dark:text-neutral-300 mb-6">
                                    {t('gettingStarted.cta.description', { defaultValue: 'Explore our curated tech stacks to see how these tools fit together in real-world scenarios.' })}
                                </p>
                                <Link
                                    to="/tech-stacks"
